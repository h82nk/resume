...
var App = {
  intro: function(ret){
    ...
    var greetText = 
      "####################################################################################\n"+
      "|[[b;#00DE12;]\t\t     __  ___  __  .___  ___.    ]\t|\n"+
      "|[[b;#00DE12;]\t\t    |  |/  / |  | |   \\/   |  ]  \t|\n"+
      "|[[b;#00DE12;]\t\t    |  '  /  |  | |  \\  /  |   ] \t|\n"+
      "|[[b;#00DE12;]\t\t    |    <   |  | |  |\\/|  |    ]\t|\n"+
      "|[[b;#00DE12;]\t\t    |  .  \\  |  | |  |  |  |   ] \t|\n"+
      "|[[b;#00DE12;]\t\t    |__|\\__\\ |__| |__|  |__|]\t\t|\n"+
      "|\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  |\n"+
  ...
  github: function(){
    this.echo();
    this.echo("|  http://github.com/taekim95");
    this.echo();
  },
  exp: function(){
    this.exec('work');
  ...
  work: function(){
    ...
    this.echo("|    â€¢ Build automated bug reporting system for front-end using nightwatch.js.");
    this.echo("|    â€¢ Build test cases for user management, locale and language support, \n|      and file management system.");
    this.echo("|    â€¢ Develop Scala language plugin for Goorm IDE.");
    this.echo("|    â€¢ Improve python flask framework plugin and develop a starter boilerplate.");
    this.echo("|");
    this.echo("|  " + commandText('Public Interest Service Personnel (Military)') + "            at " + commandText("Suji Municipal Office") + "\n|  Aug 2013 - Aug 2015");
    this.echo("|    â€¢ Received Basic Military Training and staged civil defense drills \n|      to prepare for any possible disaster.");
    this.echo("|");
    this.echo("|  " + commandText('Summer Internship') + "                                       at " + commandText("MtekVision") + "\n|  Jun 2013 - Aug 2013");
    this.echo("|    â€¢ Assisted develop an internal file management system using Microsoft SharePoint.");
    this.echo("|    â€¢ Created documentations, make a PowerPoint, and host a seminar for use of SharePoint.");
    this.echo("|    â€¢ Conducted technical research on the semiconductor companies focusing on \n|      web-based marketing strategies of other semiconductor companies.");
    this.echo();
  },
  whoami: function(){
    this.exec('about');
